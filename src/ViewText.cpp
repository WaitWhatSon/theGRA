...
ViewText::ViewText(Window* _window)
{
    this->window = _window;
}

void ViewText::clockUpdate(char decSec, char sec)
{
...
void ViewText::mapFragmentUpdate(int x, int y, char current_map_char)
{
    this->window->add_ch(y, x, current_map_char);
}

void ViewText::playerPositionUpdate(int x, int y, char player_character)
{
    this->window->add_ch(y, x, player_character);
}

void ViewText::gameBar()
{
    this->window->add_str_colour(15,  0, " semester: next course:       room number:  week:            score:    time: ", 5);
}

void ViewText::gameBarUpdate(int semester, const char* course_name, const char* room_number, int week, int score)
{
...
void ViewText::updatePlayerName(std::string name)
{
...
const void ViewText::display_logo()
{
...
const void ViewText::display_options(int position, std::string best_player, int best_score)
{
...
const void ViewText::controls_display()
{
...
const void ViewText::display_quit()
{
